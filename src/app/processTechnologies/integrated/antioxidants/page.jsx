...
export default function AntioxidantsPage() {
  return (
      ...
      <main className="flex-grow pt-32 lg:pt-40">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <nav className="flex items-center gap-2 mb-16 opacity-60 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <ChevronRight size={10} />
            <span className="text-[#00a651]">Antioxidant Process Packages</span>
          </nav>
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tighter mb-8 italic leading-[0.95] uppercase">
                Antioxidant <br />Process Packages.
              </h1>
              <p className="text-slate-600 text-2xl font-medium leading-relaxed max-w-2xl italic border-l-4 border-[#00a651] pl-8">
                "Achieving molecular precision in tert-butyl phenol isolation through rigorous process simulation and high-efficiency structured packing."
              </p>
            </div>
            ...
            <div className="lg:col-span-5 aspect-square bg-white border border-black/5 relative overflow-hidden group">
               <img 
                 src="/images/processTechnologies/antioxidants.jpg" 
                 alt="Antioxidant Distillation Process System"
          ...
          <section className="mb-32 border-t border-black/10">
            <FeatureBlock 
              subtitle="Technical Complexity"
              title="Isomer Separation Logic"
              description="Tert-Butyl phenols, produced via alkylation of phenol, exist as closely boiling isomers. High-purity separation requires an integrated approach to column design and hardware selection."
              highlights={[
                "Rigorous process simulation for difficult positional isomer separation",
                "Precise column design paired with high-efficiency structured packing",
                "Consistent achievement of ≥99.5 wt% product purity"
              ]}
            />

            <FeatureBlock 
              subtitle="Operational Reliability"
              title="Start-up & Performance"
              description="Our antioxidant process packages are supported by extensive industrial history, ensuring that simulation outcomes translate accurately to stable site operation."
              highlights={[
                "Proven track record of successful industrial start-ups",
                "Integrated equipment approach for fine chemical resins and coatings",
                "High value-added recovery for surfactants and paints"
              ]}
            />
          </section>
        </div>
          ...
          items={[
            {
              ...
              description: "Extensive start-up experience in the antioxidant segment allows for the delivery of validated process packages that minimize commissioning risk."
            },
            {
              title: "Thermal Management",
              description: "Integration of falling-film evaporators and proprietary column internals ensures on-spec purity while protecting thermally sensitive intermediates."
            },
            {
              title: "Utility Optimization",
              description: "Engineered to deliver maximum separation efficiency with significantly reduced utility consumption compared to conventional distillation designs."
            }
          ]}
        />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-32">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left border-t border-black/10 pt-20">
            ...
            <div className="text-right hidden md:block">
              ...
              <Link 
                href="/processTechnologies/integrated/nmp-gbl" 
