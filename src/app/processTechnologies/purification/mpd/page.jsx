      ...
      <main className="flex-grow pt-32 lg:pt-40">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <nav className="flex items-center gap-2 mb-16 opacity-60 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <ChevronRight size={10} />
            <span className="text-[#0284C7]">m-Phenylenediamine (MPD)</span>
          </nav>
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
            ...
            <div className="lg:col-span-5 aspect-square bg-white border border-black/5 relative overflow-hidden group">
               <img 
                 src="/images/processTechnologies/mpd.jpg" 
                 alt="m-Phenylenediamine Separation and Purification System"
               ...
               <div className="absolute bottom-6 left-6">
                 <span className="text-[10px] font-black uppercase tracking-widest text-white drop-shadow-md">
                   Dividing-Wall Column Architecture
                 </span>
               </div>
            </div>
          </header>
          ...
          <section className="mb-32 border-t border-black/10">
            <FeatureBlock 
              ...
              title="Isomer Isolation"
              description="In industrial production, the presence of positional isomers, including o-phenylenediamine (OPD) and p-phenylenediamine (PPD), makes MPD purification technically challenging."
              highlights={[
                "Technically challenging isolation of m-Phenylenediamine from positional isomers",
                "Advanced solutions for high-purity requirements in the manufacture of direct dyes and cement set accelerators"
              ]}
            />
            ...
            <FeatureBlock 
              ...
              description="Chemvict’s integrated distillation and crystallization solution is designed to address the difficult separation of these positional isomers."
              highlights={[
                "Dividing-wall column design to support production meeting stringent high-purity specifications",
                "Integrated process train combining distillation and continuous crystallization"
              ]}
            />
          </section>
        </div>
          ...
          items={[
            {
              ...
              description: "Combining distillation and crystallization to solve the most difficult positional isomer separation problems."
            },
            {
              title: "Dividing-Wall Technology",
              description: "Proprietary DWC designs that enable high-purity output while optimizing energy and footprint."
            },
            {
              title: "Proven Track Record",
              description: "Extensive experience delivering process packages and equipment for chlorotoluene and related aromatic diamine units."
            }
          ]}
        />
