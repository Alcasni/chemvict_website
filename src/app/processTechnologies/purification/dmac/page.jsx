...
export default function DMACPage() {
  return (
      ...
      <main className="flex-grow pt-32 lg:pt-40">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <nav className="flex items-center gap-2 mb-16 opacity-60 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <ChevronRight size={10} />
            <span className="text-[#0284C7]">DMAC Solvent Recovery</span>
          </nav>
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tighter mb-8 italic leading-[0.95] uppercase">
                DMAC <br />Solvent Recovery.
              </h1>
              <p className="text-slate-600 text-2xl font-medium leading-relaxed max-w-2xl italic border-l-4 border-[#0284C7] pl-8">
                "DMAc is a high-performance organic solvent. In industrial operations, high-purity grades specify very low water and acidity limits, commonly below 100 ppm."
              </p>
            </div>
            ...
            <div className="lg:col-span-5 aspect-square bg-white border border-black/5 relative overflow-hidden group">
               <img 
                 src="/images/processTechnologies/dmac.jpg" 
                 alt="DMAC Purification and Solvent Recovery System"
          ...
          <section className="mb-32 border-t border-black/10">
            <FeatureBlock 
              ...
              title="Hydrolysis Management"
              description="Under acidic and elevated-temperature conditions, DMAC can undergo hydrolysis to form dimethylamine-related species and acetic acid."
              highlights={[
                "Prevention of azeotropic or difficult-to-separate mixtures in solvent recovery",
                "Management of large volumes of dilute DMAc wastewater generated in industrial operations"
              ]}
            />
            ...
            <FeatureBlock 
              ...
              description="High-purity DMAc grades often specify very low water and acidity limits, commonly below 100 ppm and in some cases below 50 ppm."
              highlights={[
                "Advanced distillation and purification design to meet stringent ppm-level specifications",
                "Optimized system parameters to mitigate decomposition during the recovery cycle"
              ]}
            />
          </section>
        </div>
          ...
          items={[
            {
              ...
              description: "Extensive experience delivering DMAc process packages and equipment for successfully commissioned installations."
            },
            {
              title: "Revamp Expertise",
              description: "Specialized in supporting greenfield projects, column revamps, and debottlenecking or capacity expansion programs."
            },
            {
              title: "Tight Specification Control",
              description: "Engineered to achieve high-purity grades requiring extreme control over water and acidity content."
            }
          ]}
        />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-32">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left border-t border-black/10 pt-20">
            ...
            <div className="text-right hidden md:block">
              ...
              <Link 
                href="/processTechnologies/purification/dmc" 
