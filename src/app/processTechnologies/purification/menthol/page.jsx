      ...
      <main className="flex-grow pt-32 lg:pt-40">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <nav className="flex items-center gap-2 mb-16 opacity-60 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <ChevronRight size={10} />
            <span className="text-[#0284C7]">Menthol Crystals</span>
          </nav>
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="text-slate-600 text-2xl font-medium leading-relaxed max-w-2xl italic border-l-4 border-[#0284C7] pl-8">
                "Menthol contains three chiral centers and therefore has eight stereoisomers. Only the l-menthol isomer provides the characteristic cooling sensation."
              </p>
            </div>
            ...
            <div className="lg:col-span-5 aspect-square bg-white border border-black/5 relative overflow-hidden group">
               <img 
                 src="/images/processTechnologies/menthol.jpg" 
                 alt="Menthol Fractionation and Crystallization System"
          ...
          <section className="mb-32 border-t border-black/10">
            <FeatureBlock 
              ...
              title="Chiral Separation"
              description="Due to its strong cooling effect, menthol is widely used in pharmaceuticals and healthcare products, fragrances and flavors, food applications, and daily-use fine chemicals."
              highlights={[
                "Isolation of l-menthol from non-cooling stereoisomers",
                "Processing of crude menthol-rich fractions into high-purity pharmaceutical grades"
              ]}
            />
            ...
            <FeatureBlock 
              ...
              description="A distillation column equipped with Chemvict highly efficient structured packing and internals produces a crude menthol-rich fraction, followed by further purification."
              highlights={[
                "Further purification using Chemvict's continuous crystallization solution for high-purity menthol",
                "Integrated process train optimized for chiral purity and sensory quality"
              ]}
            />
          </section>
        </div>
        ...
        <AdvantageGrid 
          ...
          items={[
            {
              title: "Proprietary Crystallization",
              description: "Featuring Chemvict’s unique continuous crystallization technology to reach extreme purity levels for menthol crystals."
            },
            {
              title: "Internal Efficiency",
              description: "Equipped with high-performance structured packing and internals to produce the initial crude menthol-rich fraction."
            },
            {
              title: "Industrial Reliability",
              description: "Proven track record delivering menthol process packages and equipment for successfully commissioned installations."
            }
          ]}
        />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-32">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left border-t border-black/10 pt-20">
            ...
            <div className="text-right hidden md:block">
              ...
              <Link 
                href="/processTechnologies/integrated/benzenediol" 
