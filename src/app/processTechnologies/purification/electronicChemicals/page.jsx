...
export default function ElectronicChemicalsPage() {
  return (
      ...
      <main className="flex-grow pt-32 lg:pt-40">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12">
          ...
          <nav className="flex items-center gap-2 mb-16 opacity-60 text-[10px] font-black uppercase tracking-[0.2em]">
            ...
            <ChevronRight size={10} />
            <span className="text-[#0284C7]">Electronic Chemicals</span>
          </nav>
          ...
          <header className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-32 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold tracking-tighter mb-8 italic leading-[0.95] uppercase">
                Electronic <br />Chemicals.
              </h1>
              <p className="text-slate-600 text-2xl font-medium leading-relaxed max-w-2xl italic border-l-4 border-[#0284C7] pl-8">
                "Electronic chemicals such as electronic-grade NMP, spent dilute solutions, and stripping solutions require extremely tight control of impurities and metal ions."
              </p>
            </div>
            ...
            <div className="lg:col-span-5 aspect-square bg-white border border-black/5 relative overflow-hidden group">
               <img 
                 src="/images/processTechnologies/electronic-chemicals.jpg" 
                 alt="Semiconductor Grade Purification System"
               ...
               <div className="absolute bottom-6 left-6">
                 <span className="text-[10px] font-black uppercase tracking-widest text-white drop-shadow-md">
                   Ultra-High Purity Separation Train
                 </span>
               </div>
            </div>
          </header>
          ...
          <section className="mb-32 border-t border-black/10">
            <FeatureBlock 
              ...
              description="As purity targets become increasingly stringent, electronic-chemical separation demands higher standards in process design, energy efficiency, and equipment selection."
              highlights={[
                "Tight control of impurities and metal ions at the parts-per-billion (ppb) level",
                "Advanced separation for electronic-grade NMP, spent dilute solutions, and stripping solutions"
              ]}
            />
            ...
            <FeatureBlock 
              ...
              description="Many of these materials are thermally sensitive, so the distillation system is engineered from the initial process design stage to control key factors."
              highlights={[
                "Precise management of temperature profile and residence time to minimize degradation",
                "Integration with customized column internals and equipment for on-spec purity"
              ]}
            />
          </section>
        </div>
          ...
          items={[
            {
              ...
              description: "Meeting the highest standards in process design and energy efficiency for electronic-chemical separation."
            },
            {
              title: "Thermal Sensitivity",
              description: "Engineered thermal management to protect sensitive materials during high-purity distillation."
            },
            {
              title: "Operational Stability",
              description: "Customized system designs that support long, stable process operation for semiconductor-grade chemicals."
            }
          ]}
        />
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-32">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left border-t border-black/10 pt-20">
            ...
            <div className="text-right hidden md:block">
              ...
              <Link 
                href="/processTechnologies/purification/pyridine" 
